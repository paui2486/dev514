...
class PurchaseController extends controller
{
    ...
    public function pay2GoResult(Request $request)
    {
        ...
        if ( $status == "SUCCESS" ) {
            ...
            // MSG  customer
            $subject_msg = iconv("UTF-8","big5", "【514生活頻道】感謝您報名了活動名稱，前往查看：票券連結。". urlencode(url('purchase/trade/'.$feedback->MerchantOrderNo)));
    ...
    private function successOrder($order)
    {
        ...
        // MSG  customer
        $subject_msg = iconv("UTF-8","big5", "【514生活頻道】感謝您報名了活動名稱，前往查看：票券連結。". urlencode(url('purchase/trade/'.$orders->MerchantOrderNo)));
