...
<div class="Expert-container">
    ...
    <form class="form-horizontal expert-content" role="form">
    ...
    <!--                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 100%; max-height: 300px; line-height: 20px;"></div>-->
                        <div class="expert-uploadimg">
                            ...
                            <span class="btn btn-white btn-file">
                                <span class="fileupload-new"><i class="fa fa-paper-clip"></i> 移除圖片 </span>
                            </span>
                        </div>
                    </div>
...
$("#btn").click(function () {
    $("#showBlock").append('<div class="new-url" id="div' + txtId + '"><input type="text" class="form-control new-url-text" placeholder="請輸入外部連結網址"> <input type="button" class="btn-white btn-file " value="移除連結" onclick="deltxt('+txtId+')"></div>');
    txtId++;
});
